...
import destr from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/unhead/dist/server.mjs';
import { isVNode, toValue, isRef } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/vue/index.mjs';
import { walkResolver } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/unhead/dist/utils.mjs';
import { renderToString } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/vue/server-renderer/index.mjs';
import { createHooks } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/defu/dist/defu.mjs';
...
import { SourceMapConsumer } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/errx/dist/index.js';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/vanceandersen/Desktop/Projects/HaloGuessr/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/vanceandersen/Desktop/Projects/HaloGuessr","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/vanceandersen/Desktop/Projects/HaloGuessr/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/vanceandersen/Desktop/Projects/HaloGuessr/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/vanceandersen/Desktop/Projects/HaloGuessr/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/vanceandersen/Desktop/Projects/HaloGuessr/.data/kv"}));
...
const _gafxr9XN4iOVyFiwkLinI2Buit5xCfNXJHxtZjWFc = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/vanceandersen/Desktop/Projects/HaloGuessr";
...
const _aP2s2sXnAv5VhfvKGhE4jZ1xgSSwudjgDV1i9kmEHKI = (nitroApp) => {
...
const plugins = [
  _gafxr9XN4iOVyFiwkLinI2Buit5xCfNXJHxtZjWFc,
_aP2s2sXnAv5VhfvKGhE4jZ1xgSSwudjgDV1i9kmEHKI
];

const _lazy_toSCH4 = () => Promise.resolve().then(function () { return guess_post$1; });
const _lazy_bvMboQ = () => Promise.resolve().then(function () { return random_get$1; });
const _lazy_ocSTCK = () => Promise.resolve().then(function () { return upload_post$1; });
const _lazy_SulLN_ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/guess', handler: _lazy_toSCH4, lazy: true, middleware: false, method: "post" },
  { route: '/api/screenshots/random', handler: _lazy_bvMboQ, lazy: true, middleware: false, method: "get" },
  { route: '/api/upload', handler: _lazy_ocSTCK, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_SulLN_, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_SulLN_, lazy: true, middleware: false, method: undefined }
];
...
const guess_post = defineEventHandler(async (event) => {
  try {
    ...
    const score = Math.max(0, Math.floor(1e3 * (1 - distance / maxDistance)));
    return {
      score,
...
const guess_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: guess_post
});
...
const getClientManifest = () => import('file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/vanceandersen/Desktop/Projects/HaloGuessr/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
